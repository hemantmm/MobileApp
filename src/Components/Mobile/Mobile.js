...
function Mobile() {
  return (
    <>
    {/* <div className='bg-gray-400 ml-20 mr-20 mt-10'> */}

      {/* <div className='header text-xl flex items-center justify-center'> */}
     ...
     <span className="relative text-black top-5 left-32 font-bold text-2xl text-slate-500">Products Under Mobile</span>
            ...
            {/* <Link to={`/${category}/${id}`}> */}
              <div className="border-2 border-slate-500 h-72 w-48 flex items-center bg-yellow-300 text-black" key={id}>
                <div className="flex flex-col  cursor-pointer">
                  ...
                  {/* <button className="border-3 text-lg font-bold cursor-pointer w-36 ml-5 text-center" >Add to cart</button> */}
              ...
              {/* <Link className="border-3 text-lg font-bold cursor-pointer w-36 ml-5 text-center"> Add to cart</Link> */}
              {/* <Link>Add to cart</Link> */}
                </div>
              </div>
              {/* </Link> */}
