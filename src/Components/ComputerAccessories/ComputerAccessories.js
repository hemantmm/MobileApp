...
function ComputerAccessories() {
  return (
    <>
     ...
     <span className="relative text-black top-5 left-32 font-bold text-2xl text-slate-500">Products Under ComputerAccessories</span>
